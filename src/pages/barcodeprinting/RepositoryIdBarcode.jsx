...
import { callService, updateStore, crudMaster, getBarcodePrinter, getRepositoryIdBarcodedata, printBarcodes } from '../../actions';
...
class RepositoryIdBarcode extends React.Component {
    ...
    render() {
        ...
        const repositoryIdBarcode = this.state.controlMap.has("RepositoryIdBarcode") && this.state.controlMap.get("RepositoryIdBarcode").ncontrolcode;
                        ...
                        <ListWrapper className="client-list-content">
                                ...
                                <Col>
                                    ...
                                    <div style={{ float: "right", marginRight: "1rem" }}>
                                        <Nav.Link className="btn btn-circle outline-grey mr-2"
                                            hidden={this.state.userRoleControlRights.indexOf(repositoryIdBarcode) === -1}
                                            ...
                                            onClick={() => this.props.getBarcodePrinter({
                                                ...
                                                ncontrolcode: repositoryIdBarcode,
                                                userInfo: this.props.Login.userInfo,
                                                control: "repositoryIdBarcode",
                            ...
                            {this.state.data ?
                                <DataGridWithSelection
                                    ...
                                    userInfo={this.props.Login.userInfo}
                                    data={this.state.RepositoryIdBarcode || []}
                                    ...
                                    dataResult={process(this.state.RepositoryIdBarcode || [], this.state.dataState
                                        ? this.state.dataState : { skip: 0, take: 10 })}
    ...
    reloadData = () => {
        this.props.getRepositoryIdBarcodedata({
    ...
    dataStateChangeWorklistSample = (event) => {
        let updatedList = [];
        let RepositoryIdBarcode = this.state.RepositoryIdBarcode || [];
        this.setState({
            dataResult: process(this.state.RepositoryIdBarcode || [], event.dataState),
            dataState: event.dataState, RepositoryIdBarcode, addSelectAll: event.dataState && event.dataState.filter === null ?
                this.valiateCheckAll(RepositoryIdBarcode) :
                this.valiateCheckAll(process(RepositoryIdBarcode || [], event.dataState).data)
        });
    }
    ...
    headerSelectionChange = (event) => {
        ...
        let RepositoryIdBarcode = this.state.RepositoryIdBarcode || [];
        if (checked) {
            RepositoryIdBarcode = RepositoryIdBarcode.map(item => {
            ...
            this.setState({
                RepositoryIdBarcode, selectedSampleData,
                addSelectAll: this.valiateCheckAll(process(RepositoryIdBarcode || [], this.state.dataState).data),
                deleteSelectAll: false
            });
        } else {
            let RepositoryIdBarcode = this.state.RepositoryIdBarcode || [];
            let deletedListdData = this.state.deletedList || [];
            RepositoryIdBarcode = RepositoryIdBarcode.map(x => {
                const matchedItem = eventData.find(item => x.npkid === item.npkid);
                if (matchedItem) {
                    RepositoryIdBarcode = RepositoryIdBarcode.filter(item1 => item1.npkid !== matchedItem.npkid);
            ...
            this.setState({
                RepositoryIdBarcode, selectedSampleData, deletedList: deletedListdData,
    ...
    selectionChange = (event) => {
        ...
        RepositoryIdBarcode = RepositoryIdBarcode.map(item => {
            if (item.npkid === event.dataItem.npkid) {
                ...
                if (item.selected) {
                    ...
                    RepositoryIdBarcode = RepositoryIdBarcode.filter(item1 => item1.npkid !== item.npkid)
        ...
        this.setState({
            addSelectAll: this.valiateCheckAll(process(RepositoryIdBarcode || [], this.state.dataState).data), RepositoryIdBarcode, selectedSampleData,
            deleteSelectAll: this.valiateCheckAll(RepositoryIdBarcode)
        });
    }
    ...
    componentDidUpdate(previousProps) {
        if (this.props.Login.masterData !== previousProps.Login.masterData) {
            ...
            if (this.props.Login.userInfo.nformcode !== previousProps.Login.userInfo.nformcode) {
                ...
                this.setState({
                    ...
                    dataResult: process(this.props.Login.masterData.RepositoryIdBarcode || [], this.state.dataState),
                ...
                this.setState({
                    ...
                    dataResult: process(this.props.Login.masterData.RepositoryIdBarcode ? this.props.Login.masterData.RepositoryIdBarcode : [], dataState),
        ...
        if (this.props.Login.masterData.RepositoryIdBarcode !== previousProps.Login.masterData.RepositoryIdBarcode) {
            this.setState({
                RepositoryIdBarcode: this.props.Login.masterData.RepositoryIdBarcode
            });
        }
...
export default connect(mapStateToProps, { callService, updateStore, crudMaster, getBarcodePrinter, getRepositoryIdBarcodedata, printBarcodes })(injectIntl(RepositoryIdBarcode));