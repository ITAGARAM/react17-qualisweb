...
class CompleteThirdPartyFormAcceptance extends React.Component {
    constructor(props) {
        super(props)
        const dataState = {
            skip: 0,
...
export default connect(mapStateToProps, { updateStore })(injectIntl(CompleteThirdPartyFormAcceptance));