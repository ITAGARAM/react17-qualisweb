...
class ReceiveThirdPartyFormAcceptance extends React.Component {
    constructor(props) {
        super(props)
        const dataState = {
            skip: 0,
        ...
        return (
            <><Row>
                ...
                <Col md={6}>
                    <DateTimePicker
                        name={"receiveddate"}
                        label={this.props.intl.formatMessage({ id: "IDS_RECEIVEDATE" })}
                        className='form-control'
                        placeholderText="Select date.."
...
export default connect(mapStateToProps, { updateStore })(injectIntl(ReceiveThirdPartyFormAcceptance));