...
class DisposalSampleApprovalFilter extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            lstFilterStatus: props.lstFilterStatus || [],
            ntranscode: props.selectedFilterStatus || {},
            lstTransferType: props.lstTransferType || [],
            ntransfertypecode: props.selectedTransferType || {},
            fromDate: props.fromDate,
            toDate: props.toDate,
            selectedRecord: { fromDate: props.fromDate, toDate: props.toDate, 
            ntranscode: props.selectedFilterStatus ,ntransfertypecode:props.selectedTransferType },
        };
    }
...
export default connect(mapStateToProps, {})(injectIntl(DisposalSampleApprovalFilter));