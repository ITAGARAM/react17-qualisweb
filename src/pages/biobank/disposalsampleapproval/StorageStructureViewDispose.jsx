...
const StorageStructureViewDispose = (props) => {
    ...
    const onComboChange = (selectedOption, name) => {
        ...
        rsapi()
            .post("disposalsamplesapproval/getStorageStructure", {
                "nsamplestorageversioncode": selectedOption?.item?.nsamplestorageversioncode || -1,
                "nstorageinstrumentcode": selectedOption?.item?.nstorageinstrumentcode || -1
            })
            .then(response => {
...
export default StorageStructureViewDispose;
