...
class BGSiECatalogueModal extends React.Component {
  constructor(props) {
    super(props);
  ...
  onCatalogueSubmit = () => {
    ...
    rsapi()
      .post("bgsiecatalogue/getAggregatedDataForCatalogue", {
  ...
  openView = (row) => {
    ...
    this.props.dispatch(initRequest(true));
    rsapi()
      .post("bgsiecatalogue/getDetailedDataForCatalogue", {
        nselectedprojectcode: nbioprojectcode,
        nselectedsitecode: nsitecode,
  ...
  onComboChange = (comboData, fieldName) => {
    ...
    if (fieldName === "nbioprojectcode") {
      ...
      rsapi()
        .post("bgsiecatalogue/getSiteComboForProject", {
...
export default injectIntl(connect(mapStateToProps)(BGSiECatalogueModal));
