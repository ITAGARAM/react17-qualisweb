            ...
            <Col md="12">
                <Form.Group>
                    ...
                    <Form.Check
                        ...
                        inline={true}
                        onChange={(event) => props.onInputOnChange(event, 2, attachmentType.LINK)}
                ...
                {props.hideDefaultToggle ? "" :
                    ...
                    // disabled={props.selectedRecord ? props.selectedRecord["ndefaultstatus"] === 3 ? true : false : false}  ALPD-4779  janakumar IDS_DISPLAYSTATUS to IDS_DEFAULTSTATUS
                    >
                    </CustomSwitch>
                }
            </Col>
...
export default injectIntl(AddProductFile);