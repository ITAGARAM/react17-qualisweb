...
const AddSubContractorTestAttchment = props => {
            ...
            <Col md="12">
                ...
                {props.selectedRecord && nattachmenttypecode === attachmentType.FTP &&
                    <DropZone
                        ...
                        onDrop={(event) => props.onDrop(event, "sfilename", props.maxFiles,"editable")}
                ...
                {props.selectedRecord && nattachmenttypecode === attachmentType.LINK &&
                    <>
                        <FormInput
                            ...
                            type="text"
                            onChange={(event) => props.onInputOnChange(event, 1,"editable")}
                        ...
                        <FormSelectSearch
                            ...
                            onChange={value => props.onComboChange(value, "nlinkcode", "editable")}
...
export default injectIntl(AddSubContractorTestAttchment);