...
export function getBarcodePrinter(inputParam) {
    return (dispatch) => {
        ...
        let urlArray = [];
        const getPrinter = rsapi().post("parentsamplebarcode/getPrinter", inputParam.userInfo);
...
export function getRepositoryIdBarcodedata(inputParam) {
    return (dispatch) => {
        dispatch(initRequest(true))
        let urlArray = [];
        const getParentSampleBarcodedata = rsapi().post("repositoryidbarcode/getRepositoryIdBarcode", inputParam);
