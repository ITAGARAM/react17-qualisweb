...
export function getSDLSubSampleDetail(inputData, isServiceRequired, isParentValue) {
    return function (dispatch) {
        ...
        if (isServiceRequired) {
            rsapi().post("sdlsampleapproval/getApprovalSubSample", inputParamData)
                .then(response => {
            ...
            if (isGrandChildGetRequired) {
                ...
                if (subSample) {
                    if (APSelectedTest.length === 0) {
                        ...
                        dispatch(getSDLTestDetail(inputData, true));
                    } else {
                        dispatch(getSDLTestChildTabDetail(inputData, true));
                    }
                } else {
                    dispatch(getSDLTestChildTabDetail(inputData, true));
                }
...
export function getSDLTestDetail(inputData, isServiceRequired) {
    return function (dispatch) {
        let inputParamData = {
            ntype: 2,
            nflag: 3,
        ...
        dispatch(initRequest(true));
        if (isServiceRequired) {
            rsapi().post("sdlsampleapproval/getApprovalTest", inputParamData)
                .then(response => {
...
export function getSDLTestChildTabDetail(inputData, isServiceRequired) {
    return function (dispatch) {
        if (inputData.ntransactiontestcode && inputData.ntransactiontestcode.length > 0) {
            ...
            switch (inputData.activeTestTab) {
                case "IDS_RESULTS":
                    url = "sdlsampleapproval/getSDLApprovalParameter"
                    activeName = "ApprovalParameter"
                    dataStateName = "resultDataState"
                    break;
                ...
                case "IDS_TESTCOMMENTS":
                    ...
                    break;
                case "IDS_DOCUMENTS":
                    url = "sdlsampleapproval/getapprovalparameter"
                    break;
                case "IDS_RESULTCHANGEHISTORY":
                    url = "sdlsampleapproval/getSDLApprovalResultChangeHistory"
                    activeName = "ApprovalResultChangeHistory"
                    dataStateName = "resultChangeDataState"
                    break;
                case "IDS_TESTAPPROVALHISTORY":
                    url = "sdlsampleapproval/getSampleApprovalHistory"
                    activeName = "ApprovalHistory"
                    dataStateName = "historyDataState"
                    break;
...
export function getSDLSampleChildTabDetail(inputData) {
    return function (dispatch) {
        if (inputData.npreregno.length > 0) {
            ...
            switch (inputData.activeSampleTab) {
                ...
                case "IDS_PRINTHISTORY":
                    url = "sdlsampleapproval/getPrintHistory"
                    break;
                case "IDS_REPORTHISTORY":
                    url = "sdlsampleapproval/getCOAHistory"
                    break;
...
export function sdlPerformAction(inputParam) {
    return function (dispatch) {

        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/performAction", inputParam.inputData)
            .then(response => {
                if (response.data.rtn === undefined || response.data.rtn === "Success") {
                    ...
                    let masterData = {
                        //     ...inputParam.masterData,
                             ...
                             FilterStatusValue : inputParam.masterData.FilterStatusValue,
                             realFilterStatusValue : inputParam.masterData.FilterStatusValue
                        // AP_SAMPLE: response.data["AP_SAMPLE"],
                        // AP_SUBSAMPLE: response.data["AP_SUBSAMPLE"],
                        // AP_TEST: response.data["AP_TEST"],
                        // APSelectedSample: response.data["APSelectedSample"],
                        // APSelectedSubSample: response.data["APSelectedSubSample"],
                        // APSelectedTest: response.data["APSelectedTest"],
...
export function sdlUpdateDecision(inputParam) {

    return function (dispatch) {
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/updateDecision", inputParam.inputData)
            .then(response => {
                let responseData = { ...response.data }
                responseData = sortData(responseData)
                // dispatch({type: DEFAULT_RETURN, payload:{
...
export function getSDLRegistrationType(inputData) {
    return function (dispatch) {
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/getRegistrationType", inputData)
            .then(response => {
                let responseData = { ...response.data }
                responseData = sortData(responseData)
                dispatch({
...
export function getSDLRegistrationSubType(inputData) {
    return function (dispatch) {
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/getRegistrationSubType", inputData)
            .then(response => {
                let responseData = { ...response.data }
                responseData = sortData(responseData)
                dispatch({
...
export function getSDLFilterStatus(inputData) {
    return function (dispatch) {
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/getApproveConfigVersionRegTemplateDesign", inputData)
            .then(response => {
                let responseData = { ...response.data }
                responseData = sortData(responseData)
                dispatch({
...
export function getSDLFilterBasedTest(inputData) {
    return function (dispatch) {
        if (inputData.napprovalversioncode) {
            dispatch(initRequest(true));
            rsapi().post("sdlsampleapproval/getFilterBasedTest", inputData)
                .then(response => {
...
export function getSDLApprovalVersion(inputParam) {
    return function (dispatch) {
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/getApprovalVersion", inputParam.inputData)
            .then(response => {
                let responseData = { ...response.data }
                //  responseData = sortData(responseData)
                dispatch({
...
export function getSDLApprovalSample(inputParam) {
    return function (dispatch) {
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/getApprovalSample", inputParam.inputData)
            .then(response => {
                let responseData = { ...response.data }
                // responseData = sortData(responseData)
                let masterData = {
                ...
                dispatch({
                    type: DEFAULT_RETURN, payload: {
                        ...
                        filterSubmitValueEmpty: false   // ALPDJ21-17  Added filterSubmitValueEmpty by Vishakh (10-07-2025)
                    }
                })
            })
            .catch(error => {
...
export function getSDLStatusCombo(inputParam) {
    return function (dispatch) {
        let inputData = {
        ...
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/getStatusCombo", inputData)
            .then(response => {
                let responseData = { ...response.data }
                //responseData = sortData(responseData)
...
export function getSDLParameterEdit(inputParam) {
    return function (dispatch) {
        let inputData = {
        ...
        if (inputData.ntransactiontestcode && inputData.ntransactiontestcode.length > 0) {
            dispatch(initRequest(true));
            rsapi().post("sdlsampleapproval/getEditParameter", inputData)
                .then(response => {
                    let responseData = { ...response.data }
                    responseData = sortData(responseData)
                    dispatch({
...
export function validateSDLEsignforApproval(inputParam) {
    return (dispatch) => {
        dispatch(initRequest(true));
            ...
            .then(response => {
                if (response.data.credentials === "Success") {
                    ...
                    if (inputParam.operation === 'dynamic') {
                        ...
                        dispatch(sdlPerformAction(inputParam["screenData"]["inputParam"], inputParam["screenData"]["masterData"]))
                        ...
                        dispatch(generateSDLCOAReport(inputParam["screenData"]["inputParam"]['reporparam']))
                    }
                        ...
                        inputParam["screenData"]["inputParam"]["inputData"]["userinfo"] = inputParam.inputData.userinfo;
                        dispatch(sdlUpdateDecision(inputParam["screenData"]["inputParam"]))
                    }
                        ...
                        dispatch(updateSDLEnforceStatus(inputParam["screenData"].inputParam))
                    }
                }
            })
            .catch(error => {
...
export function SDLPreviewSampleReport(inputParam) {
    return function (dispatch) {
        ...
        rsapi().post("sdlsampleapproval/previewSampleReport", inputData)
            .then(response => {
...
export function generateSDLCOAReport(inputParam) {
    return function (dispatch) {
        ...
        rsapi().post("sdlsampleapproval/generateCOAReport", inputData)
            .then(response => {
...
export function getSDLEnforceCommentsHistory(selectedParam, masterData, userInfo, idsName, dataField) {
    return function (dispatch) {
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/getEnforceCommentsHistory", {
...
export function reportSDLGenerate(inputParam) {
    return function (dispatch) {
...
export function ViewSDLPatientDetails(masterData, screenName, userInfo, viewdetails) {
    return function (dispatch) {
        dispatch(initRequest(true));
        const selectedRecord = {
            ntestcode: viewdetails.test.ntestcode
        }
        rsapi().post("sdlsampleapproval/getSampleViewDetails", { selectedRecord, PatientId: viewdetails.test.spatientid, npreregno: viewdetails.test.npreregno, userinfo: userInfo })
            .then(response => {
...
export function getSDLTestBasedCompletedBatch(inputData) {
    return function (dispatch) {
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/getTestBasedOnCompletedBatch", inputData)
            .then(response => {
                dispatch({
                    type: DEFAULT_RETURN,
                    payload: {
...
export function updateSDLResultCorrection(inputParam) {
    return function (dispatch) {
        dispatch(initRequest(true));
        const formData = inputParam.formData;
        formData.append("userinfo", JSON.stringify(inputParam.inputData.userinfo));
        rsapi().post("sdlsampleapproval/updateReleaseParameter", formData)
            .then(response => {
                let responseData = { ...response.data }
                responseData = sortData(responseData)
...
export function updateSDLEnforceStatus(inputParam) {

    return function (dispatch) {
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/updateEnforceStatus", inputParam.inputData)
            .then(response => {
                let responseData = { ...response.data }
                responseData = sortData(responseData)
                replaceUpdatedObject(responseData["AP_SAMPLE"], inputParam.masterData.AP_SAMPLE, "npreregno");
...
export function checkSDLReleaseRecord(inputParam) {
    return function (dispatch) {

        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/checkReleaseRecord", inputParam.inputData)
            .then(response => {
...
export function getSDLTestResultCorrection(inputParam) {
    return function (dispatch) {
        ...
        if (inputData.ntransactiontestcode && inputData.ntransactiontestcode.length > 0) {
            dispatch(initRequest(true));
            rsapi().post("sdlsampleapproval/getTestResultCorrection", inputData)
                .then(response => {
                    let responseData = { ...response.data }
                    responseData = sortData(responseData)
                    let masterData = {
...
export function fetchSDLParameterDetails(editParam) {
    return function (dispatch) {
        let additionalInfo = [];
        ...
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/getReleaseResults", inputParamData)
            .then(response => {
...
export function getSDLTestApprovalFilterDetails(inputParam) {
    return function (dispatch) {
        dispatch(initRequest(true));
        rsapi().post("sdlsampleapproval/getTestApprovalFilterDetails", { ...inputParam.inputData })
            .then(response => {
                let masterData = {
                    ...inputParam.masterData,
                    ...response.data
