...
import { Grid, GridColumn, GridColumnMenuFilter, GridNoRecords, GridToolbar, GridColumn as CheckBoxColumn } from '@progress/kendo-react-grid';
...
class DataGridSelection extends React.Component {
    ...
    render() {
        ...
        const treeViewId = this.props.controlMap && this.props.controlMap.has("TreeView".concat(methodUrl))
            && this.props.controlMap.get("TreeView".concat(methodUrl)).ncontrolcode;
        ...
        const storeProccessedSampleId = this.props.controlMap && this.props.controlMap.has("StoreProccessedSample")
            && this.props.controlMap.get("StoreProccessedSample").ncontrolcode;
                            ...
                            <Grid
                                ...
                                {this.props.isToolBarRequired ?
                                    <GridToolbar>
                                        ...
                                        {this.props.isStroageRequired === false ? <></> :
                                            <Button className="btn btn-circle outline-grey ml-2" variant="link"  //modified by sujatha for changing style
                                                data-tooltip-id="my-tooltip" data-tooltip-content={this.props.intl.formatMessage({ id: "IDS_STORE" })}
                                                // data-for="tooltip-grid-wrap"
                                                hidden={this.props.userRoleControlRights && this.props.userRoleControlRights.indexOf(storeProccessedSampleId) === -1}
                                                onClick={() => this.props.storeSample(storeProccessedSampleId)}>
                                        ...
                                        {this.props.isSampleDeleteRequired === false ? <></> :
                                            <Button className="btn btn-circle outline-grey ml-2" variant="link" //modified by sujatha for changing style
                                                ...
                                                //onClick={() => this.props.deleteSample(deleteId)}
                                                onClick={() => this.handleClickDelete({ ...this.props.deleteParam, ncontrolCode: deleteId })}
                                                >
                                                    ...
                                                    <td className={`k-grid-content-sticky k-command-cell pl-0 selectedId === row["dataItem"][this.props.primaryKeyField] ? 'active' : ''`} style={{ left: '0', right: '0', borderRightWidth: '1px', textAlign: 'center' }}>
                                                        <>
                                                            ...
                                                            <FontIconWrap className="d-font-icon action-icons-wrap"
                                                                ...
                                                                data-place="left"
                                                                hidden={this.props.
                                                                    userRoleControlRights && this.props.userRoleControlRights.indexOf(treeViewId) === -1}
...
export default connect(mapStateToProps, { dynamicFileDownload, undefined })(injectIntl(DataGridSelection));